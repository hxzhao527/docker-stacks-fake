...
# c.NotebookApp.certfile = '/etc/notebook/cert.'
...
c.NotebookApp.notebook_dir = '/ext'
...
c.NotebookApp.password = passwd(
    getenv("PASSWORD", "hxzhao527"))  # default hxzhao527
...
##
c.ContentsManager.root_dir = '/ext'
...
##
c.FileContentsManager.root_dir = '/ext'
